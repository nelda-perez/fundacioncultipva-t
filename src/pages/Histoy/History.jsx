...
function History() {
  return (
    <ContainerPage>
      ...
      <p>
        El compromiso de <strong>FUNDACION CULTIPVA-T</strong> empezó con un
        sueño que se transformó, gracias a una visión dada por Dios. La palabra
        contenida en
        <b> Génesis 12:1 </b>
      ...
      <p>
        ...
        ofrecían apoyo académico, económico, espiritual, emocional, laboral,
        etc., a jóvenes que abandonaban estos programas estatales.
      </p>
      <p>
        Sin embargo, las limitaciones de estas acciones hicieron que
        <b> CULTIPVA-T </b>
      ...
      <p>
        El objetivo es ir hasta donde está la necesidad y llevar la provisión
        indicada para cada caso. En diciembre del año 2021 se inicia el proyecto
        en Ciudad Bolívar con 22 jóvenes, algunos de ellos abandonados y
        huérfanos, como parte del proyecto, las acciones de la fundación se han
        extendido a otros habitantes del sector y familias de esa misma
        comunidad.
      </p>
      ...
      <p>
        ...
        Estancia, localidad Ciudad Bolívar en la ciudad de Bogotá - Colombia y
        allí comenzó el proceso con la comunidad.
      </p>
      <p>
        CULTIPVA-T se unió a otras entidades, en esa zona de Bogotá, y así
        comenzó a trabajar con sus jóvenes para que recobraran la identidad
        distorsionada y adquirieran una verdadera identidad en Cristo. En el año
